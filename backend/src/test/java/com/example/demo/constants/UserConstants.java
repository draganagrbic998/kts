...
public class UserConstants {
	...
	public static final String EMAIL_ONE = "email_one";
	public static final String FIRST_NAME_ONE = "first_name_one";
	public static final String LAST_NAME_ONE = "last_name_one";
	...
	public static final String LOGIN_EMAIL = "asd";
	public static final String LOGIN_PASSWORD = "asd";
	public static final String LOGIN_FIRST_NAME = "asd";
	public static final String LOGIN_LAST_NAME = "asd";
