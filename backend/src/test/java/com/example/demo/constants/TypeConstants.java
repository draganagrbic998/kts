...
public class TypeConstants {
	...
	public static final String NAME_ONE = "type_one";
	public static final String PLACEMARK_ONE = "placemark_one";
	
	public static final long ID_TWO = 2;
	public static final String NAME_TWO = "type_two";
	public static final String PLACEMARK_TWO = "placemark_two";
