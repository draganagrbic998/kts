...
public class CulturalOfferServiceTest {
	...
	public void testHasNameNewOfferNonExisting() {
		...
		Mockito.when(this.culturalOfferRepository.hasName(param.getId(), param.getName())).thenReturn(null);
	...
	public void testHasNameNewOfferExisting() {
		...
		Mockito.when(this.culturalOfferRepository.hasName(param.getId(), param.getName())).thenReturn(new CulturalOffer());
	...
	public void testFilterNamesEmpty() {
		Mockito.when(this.culturalOfferRepository.filterNames(FilterConstants.FILTER_ALL))
		.thenReturn(List.of(CulturalOfferConstants.NAME_ONE, CulturalOfferConstants.NAME_THREE, CulturalOfferConstants.NAME_TWO));
		List<String> names = 
	...
	public void testFilterNamesAll() {
		Mockito.when(this.culturalOfferRepository.filterNames(CulturalOfferConstants.FILTER_NAME_ALL))
		.thenReturn(List.of(CulturalOfferConstants.NAME_ONE, CulturalOfferConstants.NAME_THREE, CulturalOfferConstants.NAME_TWO));
		List<String> names = 
				this.culturalOfferService
	...
	public void testFilterNamesOne() {
		Mockito.when(this.culturalOfferRepository.filterNames(FilterConstants.FILTER_ONE))
	...
	public void testFilterNamesNone() {
		Mockito.when(this.culturalOfferRepository.filterNames(FilterConstants.FILTER_NONE))
		.thenReturn(List.of());
		List<String> names = 
				this.culturalOfferService
	...
	public void testFilterLocationsEmpty() {
		Mockito.when(this.culturalOfferRepository.filterLocations(FilterConstants.FILTER_ALL))
		.thenReturn(List.of(CulturalOfferConstants.LOCATION_ONE, CulturalOfferConstants.LOCATION_THREE, CulturalOfferConstants.LOCATION_TWO));
	...
	public void testFilterLocationsAll() {
		Mockito.when(this.culturalOfferRepository.filterLocations(CulturalOfferConstants.FILTER_LOCATION_ALL))
		.thenReturn(List.of(CulturalOfferConstants.LOCATION_ONE, CulturalOfferConstants.LOCATION_THREE, CulturalOfferConstants.LOCATION_TWO));
		List<String> locations = 
				this.culturalOfferService
	...
	public void testFilterLocationsOne() {
		Mockito.when(this.culturalOfferRepository.filterLocations(FilterConstants.FILTER_ONE))
	...
	public void testFilterLocationsNone() {
		Mockito.when(this.culturalOfferRepository.filterLocations(FilterConstants.FILTER_NONE))
		.thenReturn(List.of());
		List<String> locations = 
				this.culturalOfferService
	...
	public void testFilterTypesEmpty() {
		Mockito.when(this.culturalOfferRepository.filterTypes(FilterConstants.FILTER_ALL))
	...
	public void testFilterTypesAll() {
		Mockito.when(this.culturalOfferRepository.filterTypes(CulturalOfferConstants.FILTER_TYPE_ALL))
		.thenReturn(List.of(TypeConstants.NAME_ONE, TypeConstants.NAME_THREE, TypeConstants.NAME_TWO));
		List<String> types = 
				this.culturalOfferService
	...
	public void testFilterTypesOne() {
		Mockito.when(this.culturalOfferRepository.filterTypes(FilterConstants.FILTER_ONE))
	...
	public void testFilterTypesNone() {
		Mockito.when(this.culturalOfferRepository.filterTypes(FilterConstants.FILTER_NONE))
		.thenReturn(List.of());
		List<String> types = 
				this.culturalOfferService
	...
	public void testFilterEmpty() {
		...
		Mockito.when(this.culturalOfferRepository.filter(filters.getName(), filters.getLocation(), filters.getType(), this.pageableAll))
	...
	public void testFilterEmptyPaginated() {
		FilterParamsDTO filters = this.filters.filtersEmpty();
		Mockito.when(this.culturalOfferRepository.filter(filters.getName(), filters.getLocation(), filters.getType(), this.pageablePart))
	...
	public void testFilterEmptyNonExistingPage() {
		FilterParamsDTO filters = this.filters.filtersEmpty();
		Mockito.when(this.culturalOfferRepository.filter(filters.getName(), filters.getLocation(), filters.getType(), this.pageableNonExisting))
	...
	public void testDeleteExisting() {
		Mockito.when(this.culturalOfferRepository.count()).thenReturn((long) MainConstants.TOTAL_SIZE);
		long size = this.culturalOfferRepository.count();
		this.culturalOfferService.delete(CulturalOfferConstants.ID_THREE);
		Mockito.when(this.culturalOfferRepository.count()).thenReturn((long) MainConstants.PART_SIZE);
		...
		Mockito.when(this.commentRepository.findByCulturalOfferIdOrderByCreatedAtDesc(CulturalOfferConstants.ID_THREE, this.pageableAll))
		.thenReturn(new PageImpl<>(List.of()));
	...
	public void testDeleteNonExisting() {
		Mockito.doThrow(EmptyResultDataAccessException.class).when(this.culturalOfferRepository).deleteById(MainConstants.NON_EXISTING_ID);
	...
	public void testAddValid() {
		...
		Mockito.when(this.culturalOfferRepository.save(offer)).thenReturn(offer);
		offer = this.culturalOfferService.save(offer, null);
		Mockito.when(this.culturalOfferRepository.count()).thenReturn(size + 1);
		assertEquals(size + 1, this.culturalOfferRepository.count());
	...
	public void testAddNullType() {
		CulturalOffer offer = this.testingOffer();
		offer.setType(null);
		Mockito.when(this.culturalOfferRepository.save(offer)).thenThrow(ConstraintViolationException.class);
	...
	public void testAddNonUniqueName() {
		CulturalOffer offer = this.testingOffer();
		offer.setName(CulturalOfferConstants.NAME_ONE);
		Mockito.when(this.culturalOfferRepository.save(offer)).thenThrow(DataIntegrityViolationException.class);
		this.culturalOfferService.save(offer, null);
	}
