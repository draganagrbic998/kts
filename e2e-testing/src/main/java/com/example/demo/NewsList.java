...
public class NewsList {
	...
	public boolean newsTextContainParam(String param) {
		return this.browser.findElements(By.xpath("//*/app-news-list/app-news-details[1]/div/mat-card/mat-card-content/div[2]"))
